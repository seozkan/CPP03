...
/*   Updated: 2023/06/14 11:43:55 by seozkan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string &target)
{
    ...
    {
        std::cout << _name << " ClapTrap attacks " << target << " and causes " 
            << _attackDamage << " hit points of damage." << std::endl;
        _energyPoints--;
    }
    else
        std::cout << _name << " ClapTrap can't attack. It has no hit points or energy points left." << std::endl;
}
